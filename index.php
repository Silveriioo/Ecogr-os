                        ...
                        ?>
                            ...
                            ?>
                                <div class="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                                    ...
                                    <button id="buttonRegModal2"><a href="#" class="text-sm font-medium text-gray-700 hover:text-gray-800">Criar uma
                                            conta</a></button>
                                </div>
                            <?php
                            }
                    ...
                    <div class="pointer-events-auto w-screen max-w-md">
                        <div class="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                            ...
                            <div class="border-t border-gray-200 px-4 py-6 sm:px-6">
                                ...
                                <div class="mt-6">
                                    <a href="view/pages/carrinho" class="flex items-center justify-center rounded-md border border-transparent bg-indigo-600 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-indigo-700">Confirmar</a>
                                </div>
